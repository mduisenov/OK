...
public class GetGroupLinksPageRequest extends BaseRequest implements TargetUrlGetter {
    private String groupId;
    private String url;

    public GetGroupLinksPageRequest(String baseWebUrl, String groupId) {
        this.url = baseWebUrl;
        this.groupId = groupId;
    }

    public String getMethodName() {
        return "api/group_links";
    }
