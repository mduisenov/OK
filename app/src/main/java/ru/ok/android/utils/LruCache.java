...
public class LruCache<K, V> {
    ...
    public interface EvictionListener<K, V> {
        void onEntryEvicted(boolean z, K k, V v, V v2);
    }
    ...
    L_0x0044:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: ru.ok.android.utils.LruCache.trimToSize(int):void");
    }
    ...
    protected void entryRemoved(boolean evicted, K key, V oldValue, V newValue) {
        if (this.evictionListener != null) {
            this.evictionListener.onEntryEvicted(evicted, key, oldValue, newValue);
        }
    }
