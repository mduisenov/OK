...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    /* renamed from: ru.ok.android.ui.swiperefresh.MaterialProgressDrawable.1 */
    class C12711 extends Animation {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            this.val$ring.setEndTrim(startingEndTrim + (MaterialProgressDrawable.START_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime) * (0.8f - minProgressArc)));
            this.val$ring.setStartTrim(startingTrim + (0.8f * MaterialProgressDrawable.END_CURVE_INTERPOLATOR.getInterpolation(interpolatedTime)));
    ...
    /* renamed from: ru.ok.android.ui.swiperefresh.MaterialProgressDrawable.2 */
    class C12722 implements AnimationListener {
        final /* synthetic */ Ring val$ring;
    ...
    /* renamed from: ru.ok.android.ui.swiperefresh.MaterialProgressDrawable.3 */
    class C12733 implements Callback {
        C12733() {
        }
    ...
    private void setupAnimators() {
        Ring ring = this.mRing;
        Animation animation = new C12711(ring);
        animation.setRepeatCount(-1);
        animation.setRepeatMode(1);
        animation.setInterpolator(LINEAR_INTERPOLATOR);
        animation.setAnimationListener(new C12722(ring));
