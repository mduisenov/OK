    ...
    private class InternalViewPagerListener implements OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            ...
            if (tabStripChildCount != 0 && position >= 0 && position < tabStripChildCount) {
                ...
                View nextTitle = SlidingTabLayout.this.mTabStrip.getChildAt(position + 1);
                SlidingTabLayout.this.scrollToTab(position, (int) (0.5f * (((float) (selectedOffset + (nextTitle == null ? 0 : nextTitle.getWidth()))) * positionOffset)));
    ...
    private void scrollToTab(int tabIndex, int positionOffset) {
        ...
        if (tabStripChildCount != 0 && tabIndex >= 0 && tabIndex < tabStripChildCount) {
            ...
            if (selectedChild != null && selectedChild.getMeasuredWidth() != 0) {
                int targetScrollX = ((selectedChild.getLeft() + positionOffset) - (getWidth() / 2)) + (selectedChild.getWidth() / 2);
