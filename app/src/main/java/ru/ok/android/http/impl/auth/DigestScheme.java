...
import ru.ok.android.http.message.BasicHeaderValueFormatter;
...
public class DigestScheme extends RFC2617Scheme {
    ...
    private Header createDigestHeader(Credentials credentials, HttpRequest request) throws AuthenticationException {
        ...
        try {
            ...
            Appendable stringBuilder = new StringBuilder(NotificationCompat.FLAG_LOCAL_ONLY);
            ...
            CharArrayBuffer buffer = new CharArrayBuffer(NotificationCompat.FLAG_HIGH_PRIORITY);
            if (isProxy()) {
